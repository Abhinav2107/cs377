...
DEF_SYSCALL(Sync, SYS_SYNC, int, (void),, SYSCALL_REGS_0)
    DEF_SYSCALL(Format, SYS_FORMAT, int,
                (const char *devname, const char *fstype), const char *arg0 =
                devname;
...
DEF_SYSCALL(Rename, SYS_RENAME, int,
                (const char *oldpath, const char *newpath), const char *arg0 =
            oldpath;
            size_t arg1 = strlen(oldpath);
            const char *arg2 = newpath;
            size_t arg3 = strlen(newpath);
            , SYSCALL_REGS_4)
DEF_SYSCALL(Link, SYS_LINK, int, (const char *oldpath, const char *newpath),
...
DEF_SYSCALL(Pipe, SYS_PIPE, int, (int *read_fd, int *write_fd), int *arg0 =
            read_fd;
            int *arg1 = write_fd;
            , SYSCALL_REGS_2)
...
DEF_SYSCALL(GetUid, SYS_GET_UID, int, (),;
            , SYSCALL_REGS_0)
DEF_SYSCALL(SetEffectiveUid, SYS_SET_EFFECTIVE_UID, int, (int uid), int arg0 =
            uid;
            , SYSCALL_REGS_1)
...
DEF_SYSCALL(Mmap, SYS_MMAP, int,
            ...
            int arg4 = fd;
            , SYSCALL_REGS_5)
DEF_SYSCALL(Munmap, SYS_MUNMAP, int, (const void *addr), const void *arg0 =
            addr;
            , SYSCALL_REGS_1)
